...
var util = {
    ...
    __extends: function () {
        var options, name, src, copy, target = {}, k = 0, l = arguments.length, deep = false, clone, isArray = false;
            ...
            if ((options = arguments[k]) !== null) {
                for (name in options) {
                    ...
                    if ('undefined' == typeof copy)
                        continue;
                    if (deep)
                        target[name] = this.cloneObject(copy);
                    else
                        target[name] = copy;
                }
            }
    ...
    __extend: function () {
        var options, name, src, copy, copyIsArray, clone, target = arguments[0] || {}, i = 1, l = arguments.length, deep = false;
    ...
    randElement: function (arr) {
        if (typeof arr == 'undefined' || arr == null || arr.constructor !== Array)
    ...
    randProperty: function (obj) {
        if (typeof obj == 'undefined' || obj == null || !(obj instanceof Object))
            throw new Error('randProperty() requires an object');
        var ctr = 0, oSize = this.objectSize(obj), randNum = this.randNumber(oSize - 1);
        if (!oSize)
            throw new Error('Cannot use randProperty() on empty object.');
        for (var key in obj)
